...
//@interface TodoListObject : NSObject
//@end

@interface TodoListObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TodoListObject class]])
		{
			for (NSString *key in [[(TodoListObject*)o modules] allKeys])
			{
