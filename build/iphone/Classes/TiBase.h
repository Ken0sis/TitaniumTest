...
// in simulator we redefine to format for TodoList Developer console
...
{\
	NSString * exceptionName = [@"org.todolist." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.todolist";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITodoListNativeItemNone = -1, 
	UITodoListNativeItemSpinner = -2,
	UITodoListNativeItemProgressBar = -3,
	
	UITodoListNativeItemSlider = -4,
	UITodoListNativeItemSwitch = -5,
	UITodoListNativeItemMultiButton = -6,
	UITodoListNativeItemSegmented = -7,
	
	UITodoListNativeItemTextView = -8,
	UITodoListNativeItemTextField = -9,
	UITodoListNativeItemSearchBar = -10,
	
	UITodoListNativeItemPicker = -11,
	UITodoListNativeItemDatePicker = -12,
	
	UITodoListNativeItemInfoLight = -13,
	UITodoListNativeItemInfoDark = -14,
	
	UITodoListNativeItemDisclosure = -15,
	
	UITodoListNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TodoList instances of
